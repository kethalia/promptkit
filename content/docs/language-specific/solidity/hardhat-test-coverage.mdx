...
description: "Generate comprehensive Hardhat tests using Mocha/Chai and ethers.js that verify actual contract behavior with specific assertions on return values and state changes."
---
